                    ...
                    return (
                        ...
                        <div className={idx === imageIndex ? "slide activeSlide" : "slide"}>
                            ...
                            <div className=" md:w-[300px] ">
                                ...
                                <div className="md:border-2 bg-[#616161] border-black h-[200px] w-full md:w-[300px] md:h-[250px] flex justify-center items-center ">
                                    <div key={pokemon.id}>


                                        <p className="hidden md:block text-[#3f3f3f] pb-10 md:text-[8em] z-10 font-bold">N°{pokemon.pokedex}</p>
                                ...
                                <div className="w-full h-[130px] md:h-[150px] bg-[#232323] md:w-full text-white">
