                                                        ...
                                                        <div className=" w-full h-[1200px] md:h-[1150px] bg-[#F2F2F2] mt-5 md:w-[600px] md:rounded-tl-lg lg:h-[900px] ">
                                                            ...
                                                            <div className="md:flex md:mr-5 md:flex-col md:items-end">
                                                                ...
                                                                <div className='flex justify-center lg:justify-end '>
                                                                    <div className='cursor-pointer h-[44px] mt-2  rounded-md text-white w-[290px] hover:bg-[#0c6a8f] font-semibold lg:text-[1.2em] bg-[#30a7d7]' type="">
                                                                        <p className="pt-2 pl-12 lg:pl-6">Comprobar disponibilidad</p>
                                                                    </div>
                                                                </div>
